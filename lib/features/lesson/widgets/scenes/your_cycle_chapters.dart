...
const double _cW = 900.0, _cH = 680.0;

// _stage fills the full parent area:
//  • A full-bleed ColoredBox paints _bgCream behind the scaled canvas so that
//    the letterbox margins are the same colour as the animation's own edge
//    gradient — making blank space completely invisible.
//  • The canvas is scaled with math.min (contain) so no UI controls are clipped.
Widget _stage(Widget child) => LayoutBuilder(builder: (_, box) {
      ...
      return SizedBox(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: [
            // Background fills the container so letterbox margins are invisible.
            const ColoredBox(color: _bgCream),
            ClipRect(
...
class _Ch0State extends State<Ch0WhatIsMenstruation>
  ...
  static List<_PD> _getPhases(AppLocalizations l) => [
  ...
  Widget build(BuildContext context) {
    final phase = ch0Shared.selPhase >= 0 ? ch0Shared.selPhase : _autoPhase;
    final pd = _getPhases(AppLocalizations.of(context)!)[phase];
    ...
    return _stage(Stack(clipBehavior: Clip.hardEdge, children: [
      ...
      if (!_panels) ...[
          ...
          child: Column(
            ...
            children: [
              _CtrlPill(
                ...
                label: AppLocalizations.of(context)!.cyclePhasesBtn,
              ...
              _CtrlPill(
                ...
                label: _showLabels ? AppLocalizations.of(context)!.cycleHideLabels : AppLocalizations.of(context)!.cycleShowLabels,
                active: _showLabels,
        ...
        Positioned(top: 12, right: 16,
          child: _CtrlPill(
            icon: Icons.close_rounded, label: AppLocalizations.of(context)!.cycleCloseBtn,
        ...
        Positioned.fill(top: 50,
          child: Row(children: List.generate(4, (i) => Expanded(
            child: _MiniPhasePanel(
              pd: _getPhases(AppLocalizations.of(context)!)[i], idx: i, t: _ctrl.value,
              onTap: () => setState(() { ch0Shared.selectPhase(i); _panels = false; }),
            ),
          ))),
        ),
      ],
...
class _Ch1State extends State<Ch1UterusAndOvaries>
  ...
  List<_HS> _getHs(AppLocalizations l) => [
    ...
    return _stage(Stack(clipBehavior: Clip.hardEdge, children: [
      ...
      Positioned(top: 14, left: 0, right: 0,
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          ..._getHs(AppLocalizations.of(context)!).map((h) => GestureDetector(
        ...
        child: _glow >= 0
          ? Container(
              decoration: BoxDecoration(
                ...
                border: Border(top: BorderSide(color: _getHs(AppLocalizations.of(context)!)[_glow].color, width: 2)),
              ),
              padding: const EdgeInsets.fromLTRB(20, 10, 20, 10),
              child: Row(children: [
                Container(width: 36, height: 36, decoration: BoxDecoration(
                    color: _getHs(AppLocalizations.of(context)!)[_glow].color, shape: BoxShape.circle),
                  alignment: Alignment.center,
                  child: Text('${_getHs(AppLocalizations.of(context)!)[_glow].id + 1}', style: const TextStyle(
                      fontSize: 14, fontWeight: FontWeight.w800, color: Colors.white))),
                const SizedBox(width: 14),
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                  mainAxisAlignment: MainAxisAlignment.center, children: [
                  Text(_getHs(AppLocalizations.of(context)!)[_glow].label, style: TextStyle(fontFamily: 'Fraunces',
                      fontSize: 15, fontWeight: FontWeight.w700, color: _getHs(AppLocalizations.of(context)!)[_glow].color)),
                  const SizedBox(height: 3),
                  Text(_getHs(AppLocalizations.of(context)!)[_glow].detail, maxLines: 2, overflow: TextOverflow.ellipsis,
...
class _Ch2State extends State<Ch2TheFourPhases>
  ...
  static List<_P2> _getPhases(AppLocalizations l) => [
  ...
  @override
  Widget build(BuildContext context) {
    final ph = _getPhases(AppLocalizations.of(context)!)[_sel];
          ...
          child: Transform(
            ...
            child: CustomPaint(
              painter: _Pro3DWheelPainter(
                day: _day, sel: _sel,
                phases: _getPhases(AppLocalizations.of(context)!), t: _ctrl.value,
              ),
            ),
          ),
        ),
...
class _Ch3State extends State<Ch3CrampsAndPain>
  ...
  List<({String icon, String label, String detail, Color color})> _getRemedies(AppLocalizations l) => [
  ...
  Widget build(BuildContext context) => _stage(Stack(children: [
      ...
      child: Container(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
            Text(AppLocalizations.of(context)!.cycleCh3PainIntensity, style: TextStyle(fontSize: 9, color: kInk60, fontWeight: FontWeight.w600)),
            const SizedBox(height: 3),
    ...
    Positioned(top: 18, left: 0, right: 0,
      child: Center(child: Text(AppLocalizations.of(context)!.cycleCh3Title,
    ...
    Positioned(bottom: 0, left: 0, right: 0,
      child: Container(
        ...
        child: Row(
          children: _getRemedies(AppLocalizations.of(context)!).indexed.map((e) {
            final (i, r) = e;
  ...
  Widget build(BuildContext context) => _stage(Stack(children: [
    ...
    Positioned(left: 14, top: 14, right: 340, bottom: 14,
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(AppLocalizations.of(context)!.cycleCh4Title, style: TextStyle(fontFamily: 'Fraunces',
            fontSize: 18, fontWeight: FontWeight.w700, color: kPlum)),
        Text(AppLocalizations.of(context)!.cycleCh4Subtitle,
            style: TextStyle(fontSize: 11, color: kInk60)),
        const SizedBox(height: 8),
        Row(children: [AppLocalizations.of(context)!.cycleCh4DayM,AppLocalizations.of(context)!.cycleCh4DayT,AppLocalizations.of(context)!.cycleCh4DayW,AppLocalizations.of(context)!.cycleCh4DayTh,AppLocalizations.of(context)!.cycleCh4DayF,AppLocalizations.of(context)!.cycleCh4DayS,AppLocalizations.of(context)!.cycleCh4DaySu].map((d) => Expanded(
    ...
    Positioned(right: 10, top: 14, bottom: 14, width: 318,
      child: Column(children: [
        Container(width: double.infinity, padding: const EdgeInsets.all(16),
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(AppLocalizations.of(context)!.cycleCh4NextPeriod,
                style: TextStyle(fontSize: 11, color: Colors.white70)),
            const SizedBox(height: 4),
            Text(AppLocalizations.of(context)!.cycleDayBadge('${_len + 1}'), style: const TextStyle(fontFamily: 'Fraunces',
                fontSize: 28, fontWeight: FontWeight.w700, color: Colors.white)),
            Text(AppLocalizations.of(context)!.cycleCh4InXDays('${_len - (_period.isNotEmpty ? _period.reduce(math.max) : 5)}'),
        ...
        Container(padding: const EdgeInsets.all(13),
          ...
          child: Column(children: [
            _s(AppLocalizations.of(context)!.cycleCh4CycleLen, AppLocalizations.of(context)!.cycleCh4DaysX('$_len'), AppLocalizations.of(context)!.cycleCh4CycleLenNorm),
            _s(AppLocalizations.of(context)!.cycleCh4PeriodLen, AppLocalizations.of(context)!.cycleCh4DaysX('${_period.length}'), AppLocalizations.of(context)!.cycleCh4PeriodLenNorm),
            _s(AppLocalizations.of(context)!.cycleCh4OvulationLabel, AppLocalizations.of(context)!.cycleDayBadge('$_ov'), AppLocalizations.of(context)!.cycleCh4OvulationNorm),
            _s(AppLocalizations.of(context)!.cycleCh4FertileWindow, AppLocalizations.of(context)!.cycleCh4DaysRange, AppLocalizations.of(context)!.cycleCh4FertileNorm),
          ]),
        ),
        const SizedBox(height: 10),
        Container(padding: const EdgeInsets.all(11),
          decoration: BoxDecoration(color: Colors.white.withValues(alpha: 0.7),
              borderRadius: BorderRadius.circular(12)),
          child: Column(children: [
            _LR('🩸', AppLocalizations.of(context)!.cycleCh4LegendPeriod),
            _LR('🥚', AppLocalizations.of(context)!.cycleCh4LegendOvulation),
            _LR('🌱', AppLocalizations.of(context)!.cycleCh4LegendFertile),
            _LR('🔮', AppLocalizations.of(context)!.cycleCh4LegendPredicted),
          ]),
        ),
      ]),
    ),
...
class _Ch5State extends State<Ch5CommonMyths> with TickerProviderStateMixin {
  ...
  List<_MC> _getCards(AppLocalizations l) => [
  ...
  Widget build(BuildContext context) => _stage(Stack(children: [
    ...
    Positioned(left: 20, top: 16, right: 20,
      child: Row(children: [
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(AppLocalizations.of(context)!.cycleCh5Title, style: TextStyle(fontFamily: 'Fraunces',
              fontSize: 22, fontWeight: FontWeight.w700, color: kPlum)),
          Text(AppLocalizations.of(context)!.cycleCh5Subtitle,
              style: TextStyle(fontSize: 11, color: kInk60)),
        ])),
        AnimatedContainer(
          ...
          child: Text(_busted == 5 ? AppLocalizations.of(context)!.cycleCh5AllBusted : AppLocalizations.of(context)!.cycleCh5XBusted('$_busted'),
    ...
    Positioned(left: 12, top: 68, right: 12, bottom: 12,
      child: Wrap(spacing: 10, runSpacing: 10,
        children: List.generate(_getCards(AppLocalizations.of(context)!).length, (i) => _FC(
          card: _getCards(AppLocalizations.of(context)!)[i], ctrl: _flips[i], rev: _rev[i], onTap: () => _flip(i),
        )),
      ),
    ),
  ]));
        ...
        child: Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(100)),
                child: Text(showFact ? AppLocalizations.of(context)!.cycleCh5FactLabel : AppLocalizations.of(context)!.cycleCh5MythLabel,
            ...
            Text(showFact ? card.fact : card.myth,
                ...
                maxLines: 3, overflow: TextOverflow.ellipsis),
            const Spacer(),
            Text(showFact ? AppLocalizations.of(context)!.cycleCh5TapFact : AppLocalizations.of(context)!.cycleCh5TapMyth,
