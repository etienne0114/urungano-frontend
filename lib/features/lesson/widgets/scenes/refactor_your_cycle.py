...
# Add flutter gen-l10n import if missing
...
content = re.sub(
    ...
    _PD(l.cyclePhaseMenstrual, l.cyclePhaseMenstrualDays, l.cyclePhaseMenstrualDesc, kRose),
    _PD(l.cyclePhaseFollicular, l.cyclePhaseFollicularDays, l.cyclePhaseFollicularDesc, kAmber),
    _PD(l.cyclePhaseOvulation, l.cyclePhaseOvulationDay, l.cyclePhaseOvulationDesc, kSage),
    _PD(l.cyclePhaseLuteal, l.cyclePhaseLutealDays, l.cyclePhaseLutealDesc, const Color(0xFFD4A830)),
  ];''',
...
# Fix instantiation of UterusPainter
...
content = re.sub(
    r'  static const _phases = \[\n.*?\];',
    r'''  static List<_PD> _getPhases(AppLocalizations l) => [
    _PD(l.cyclePhaseMenstrual, l.cyclePhaseMenstrualDays, l.cyclePhaseMenstrualDescAlt, kRose, l.cycleHormoneMenstrualLevel),
    _PD(l.cyclePhaseFollicular, l.cyclePhaseFollicularDays, l.cyclePhaseFollicularDescAlt, kAmber, l.cycleHormoneFollicularLevel),
    _PD(l.cyclePhaseOvulation, l.cyclePhaseOvulationDay, l.cyclePhaseOvulationDescAlt, kSage, l.cycleHormoneOvulationLevel),
    _PD(l.cyclePhaseLuteal, l.cyclePhaseLutealDays, l.cyclePhaseLutealDescAlt, const Color(0xFFD4A830), l.cycleHormoneLutealLevel),
  ];''',
    content, flags=re.DOTALL
)
